...
- 需要 AWS 5 条提权路径详细命令、高价值数据搜索、CloudTrail 隐蔽性 → [references/aws-escalation.md](references/aws-escalation.md)
...
└─ 详细命令 → [references/aws-escalation.md](references/aws-escalation.md)
```
